<?php include('core/inc/globals.inc.php'); ?>
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Privacy</title></head><body style="line-height:2em;width:50%;margin:10px auto;">This Privacy Policy governs the manner in which <?=$siteinfo['fullname']?> collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="">http://marketdream.org</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by <?=$siteinfo['fullname']?>.<br><br>
...
<?=$siteinfo['fullname']?> may collect and use Users personal information for the following purposes:<br>
<ul>
...
<?=$siteinfo['fullname']?> has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>
...
<a href=""><?=$siteinfo['fullname']?></a><br>
<a href="">http://marketdream.org</a><br>
+1(978)-877-6582<br>
<a href="mailto:admin@marketdream.org">admin@marketdream.org</a><br>
<br>
This document was last updated on June 21, 2013<br><br></body></html>