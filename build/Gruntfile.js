...
grunt.loadNpmTasks('grunt-beep');
  ...
  grunt.initConfig({
    ...
    less: {
      compileCore: {
        ...
        files: {
          '../assets/css/<%= pkg.name %>.css': 'less/bootstrap.less'
        }
      },
      compileTheme: {
        options: {
        ...
        files: {
          '../assets/css/<%= pkg.name %>-theme.css': 'less/theme.less'
        }
      }
    },
    ...
    cssmin: {
      ...
      core: {
        files: {
          ...
          '../assets/css/<%= pkg.name %>-theme.min.css': '../assets/css/<%= pkg.name %>-theme.css'
        }
      },
      docs: {
        src: [
  ...
  grunt.registerTask('dist', ['clean', 'dist-css', 'copy:fonts', 'dist-js', 'dist-docs', 'beep']);
